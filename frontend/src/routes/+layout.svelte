...
>
  ...
  >
    <button
      on:click={goTop}
      class="ml-auto rounded-full bg-white text-primary px-3 sm:px-4 hover:bg-secondary hover:text-white cursor-pointer aspect-square grid place-items-center"
    >
